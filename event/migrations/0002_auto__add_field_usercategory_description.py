...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Usercategory.description'
        db.add_column(u'event_usercategory', 'description',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=50000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Usercategory.description'
        db.delete_column(u'event_usercategory', 'description')
