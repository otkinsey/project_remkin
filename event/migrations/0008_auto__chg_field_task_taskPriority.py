...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.taskPriority'
        db.alter_column(u'event_task', 'taskPriority', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Task.taskPriority'
        db.alter_column(u'event_task', 'taskPriority', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        u'event.task': {
            ...
            'taskPriority': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
