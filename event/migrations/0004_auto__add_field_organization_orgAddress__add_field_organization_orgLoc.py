...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.orgAddress'
        db.add_column(u'event_organization', 'orgAddress',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.orgLocationDescription'
        db.add_column(u'event_organization', 'orgLocationDescription',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.longitude'
        db.add_column(u'event_organization', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.latitude'
        db.add_column(u'event_organization', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.orgAddress'
        db.delete_column(u'event_organization', 'orgAddress')

        # Deleting field 'Organization.orgLocationDescription'
        db.delete_column(u'event_organization', 'orgLocationDescription')

        # Deleting field 'Organization.longitude'
        db.delete_column(u'event_organization', 'longitude')

        # Deleting field 'Organization.latitude'
        db.delete_column(u'event_organization', 'latitude')
